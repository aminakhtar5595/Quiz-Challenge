    ...
    render() {
        return (
            <View style={{
                ...
                }}>What was the name of the hero in the 80s animated video game Dragon Lair?</Text>
