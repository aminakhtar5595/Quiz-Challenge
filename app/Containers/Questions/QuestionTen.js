...
export default class QuestionTen extends React.Component {
    constructor() {
        super()
        ...
        return (
            <View style={{
                ...
                <View style={{ paddingBottom: 30 }}>
                    ...
                    }}>Questions 10 of 20</Text>

                    <Text style={{
                        fontSize: 14, color: 'gray'
                    }}>Entertainment: Games</Text>
                ...
                }}>In World of Warcraft lore who organized the creation of the Paladins?</Text>
                ...
                <View style={{ flexDirection: 'row', width: '100%', paddingBottom: 40, justifyContent: 'center' }}>
                    ...
                    disabled={this.state.right == true || this.state.wrong == true ? true : false}>
                        ...
                        color: 
                        this.state.right == true || this.state.wrong == true ? '#A3A3A3' : 
                        '#000' }}>Uther the Lightbringer</Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={{ flexDirection: 'row', width: '100%', justifyContent: 'center' }}>
                    ...
                    disabled={this.state.right == true || this.state.wrong == true ? true : false}>
                        ...
                        color: 
                        this.state.right == true || this.state.wrong == true ? '#A3A3A3' : 
                        '#000' }}>Sargeras The Daemon Lord</Text>
                    </TouchableOpacity>
                </View>
                {
...

                {
                    ...
                    }} onPress={() => Actions.question_eleven()}>
