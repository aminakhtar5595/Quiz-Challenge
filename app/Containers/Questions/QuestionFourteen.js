    ...
    render() {
        return (
            <View style={{
                ...
                }}>These two countries held a commonwealth from the 16th to 18th century?</Text>
                ...
                <View style={{ flexDirection: 'row', width: '100%', paddingBottom: 40, justifyContent: 'center' }}>
                    ...
                    disabled={this.state.right == true || this.state.wrong == true ? true : false}>
                        ...
                        color: 
                        this.state.right == true || this.state.wrong == true ? '#A3A3A3' : 
                        '#000' }}>North Korea and South Korea</Text>
                    </TouchableOpacity>
                    ...
                    disabled={this.state.right == true || this.state.wrong == true ? true : false}>
                        ...
                        color: 
                        this.state.right == true || this.state.wrong == true ? '#A3A3A3' : 
                        '#000' }}>Bangladesh and Bhutan</Text>
                    </TouchableOpacity>
                </View>
                {
...

                {
                    ...
                    }} onPress={() => Actions.question_fifteen()}>
