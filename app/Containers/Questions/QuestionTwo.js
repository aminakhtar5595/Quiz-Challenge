    ...
    render() {
        return (
            <View style={{
                ...
                }}>What is the scientific name for modern day humans?</Text>
                
                <View style={{ flexDirection: 'row', width: '100%', paddingBottom: 40, justifyContent: 'center' }}>
                    <TouchableOpacity style={{
                        backgroundColor: 
                        this.state.right == true ? '#F5F5F5' : 
                        this.state.wrong == true ? '#F5F5F5' : '#E5E6E5', width: '45%', paddingHorizontal: 10, paddingVertical: 10,
                ...
                <View style={{ flexDirection: 'row', width: '100%', justifyContent: 'center' }}>
                    ...
                    disabled={this.state.right == true || this.state.wrong == true ? true : false}>
                        ...
                        color: 
                        this.state.right == true || this.state.wrong == true ? '#A3A3A3' : 
                        '#000', }}>Homo Neanderthalensis</Text>
                    </TouchableOpacity>
...

                {
                    ...
                    }} onPress={() => Actions.question_three()}>
