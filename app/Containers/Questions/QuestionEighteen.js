...
export default class QuestionEighteen extends React.Component {
    constructor() {
        super()
        ...
        return (
            <View style={{
                ...
                <View style={{ paddingBottom: 30 }}>
                    ...
                    }}>Questions 18 of 20</Text>

                    <Text style={{
                        fontSize: 14, color: 'gray'
                    }}>Entertainment: Video and Games</Text>
                ...
                }}>In Left 4 Dead which campaign has the protagonists going through a subway in order to reach a hospital for evacuation?</Text>
...

                {
                    ...
                    }} onPress={() => Actions.question_nineteen()}>
